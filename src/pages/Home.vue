...
function generateEquation() {
  ...
  const isAEqualToOne = Math.random() < 0.9  // вероятность для a = 1
  const isBZero = Math.random() < 0.05       // вероятность для b = 0
  const isCZero = Math.random() < 0.05       // вероятность для c = 0
